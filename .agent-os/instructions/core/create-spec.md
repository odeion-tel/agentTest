...
<mcp_context7_enrichment>
ACTION: Call Context7 MCP with libraries/frameworks from tech-stack.md
GOAL: Attach version-correct API shapes and code examples
OUTPUT: Inline citations to sources + links
BOUNDS: Top 5 APIs only, ≤ 300 tokens
</mcp_context7_enrichment>
