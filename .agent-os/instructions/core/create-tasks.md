...
<subtasks> - count: up to 8 per major task - format: decimal notation (1.1, 1.2) - first_subtak: propose lean test plan - second_subtask: write approved minimal tests - last_subtask: verify all tests pass
</subtasks>
</task_structure>
...
- [ ] 1.1 Propose Lean Test Plan for [COMPONENT] (top 3 risks, minimal falsification tests, est. token cost)
- [ ] 1.2 Write approved minimal tests for [COMPONENT] (golden path + ≤2 invariants, table-driven ≤6 rows)
...
- Follow TDD approach with Lean Testing Charter (@.agent-os/standards/lean-testing.md)
